...
|                     |                                                                                                                          |                |           |                                                                      |
| cv-libs             | [RPP](https://github.com/ROCm/rocm-libraries/tree/develop/projects/rpp)                                                  | rocm-libraries | 🟡        | Experimental; off by default (opt in with `-DTHEROCK_ENABLE_RPP=ON`) |
|                     |                                                                                                                          |                |           |                                                                      |
